                        ...
                        <div className={`flex rounded dark:bg-dark-900 border items-center overflow-hidden`}>
                          ...
                          >
                            ...
                            <div className={'flex-1 px-3'}>
                                ...
                                <p className={'line-clamp-2'}>{ dataFormatter.scansOneListFormatter(item.scan) }</p>
                            </div>

                            <div className={'flex-1 px-3'}>
                                <p className={'text-xs text-gray-500'}>ToolName</p>
                                <p className={'line-clamp-2'}>{ item.tool_name }</p>
                            </div>

                            <div className={'flex-1 px-3'}>
                                <p className={'text-xs text-gray-500'}>ReportPath</p>
                                <p className={'line-clamp-2'}>{ item.report_path }</p>
                            </div>
