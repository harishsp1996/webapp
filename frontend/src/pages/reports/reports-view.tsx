      ...
      <>
          ...
          <SectionMain>
            ...
            <CardBox>
                ...
                <div className={'mb-4'}>
                    <p className={'block font-bold mb-2'}>Scan</p>

                        <p>{reports?.scan?.status ?? 'No data'}</p>

                </div>

                <div className={'mb-4'}>
                    <p className={'block font-bold mb-2'}>ToolName</p>
                    <p>{reports?.tool_name}</p>
                </div>

                <div className={'mb-4'}>
                    <p className={'block font-bold mb-2'}>ReportPath</p>
                    <p>{reports?.report_path}</p>
                </div>
